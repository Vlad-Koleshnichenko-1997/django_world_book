# Generated by Django 4.0.3 on 2022-03-25 15:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dete_of_death', models.DateField(blank=True, help_text='Введите дату смерти', null=True, verbose_name='Дата смерти')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(help_text='Изменить состояние экземпляра', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Cтатус экземпляра книги')),
            ],
        ),
        migrations.AddField(
            model_name='book',
